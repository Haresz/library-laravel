    ...
    <div style="width: 600px;">
        <div class="d-flex d-flex justify-content-between">
            <form action="{{ route('filter') }}" method="GET">
                <input class="form-control me-2 rounded-pill text-dark" style="background: rgba(255, 255, 255, 0.15); width: 350px;" type="text" name="filter" placeholder="Cari judul buku" aria-label="Cari judul buku" aria-describedby="basic-addon2" value="{{ old('filter', request()->filter) }}">
            </form>
            <div class="dropdown">
